...
// JG Jun 2017 - contain partial/full refunds    
    ...
    public TicketInfo() {
        ...
        m_iTicketId = gen_Ticket_Id(); // incrementamos
        m_dDate = new Date();
    ...
    public void setTicketStatus(int ticketstatus) {
        if (m_iTicketId >0) {
            this.ticketstatus =gen_Ticket_status(m_iTicketId);
        }else{
...
// JG Aug 2014 - Add User info
        ...
        if (info == null) {
            if (m_iTicketId == 0) {
                ...
                name.add(Long.toString(m_iTicketId));                
            }
        } else {
    ...
    public String printId() {
      ...
      m_config =null;
        ...
        if (m_iTicketId > 0) {
            String tmpTicketId=Long.toString(m_iTicketId);
...
// Added JDL 28.05.13 for loyalty card functions
    ...
    public Long gen_Ticket_Id(){
        SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddHHmmssSSS");
        String dt = sdf.format(new Date());
        //String dt2= 1+dt.substring(1,dt.length());
        Long num =Long.parseLong(dt);
        return num;
    }
    
    public int gen_Ticket_status(Long id){
        String str=Long.toString(id);
        int status=Integer.parseInt(str.substring(14,str.length()));
        return status;
    }
